...
const deletePatrocinadorTorneo = async (req, res) => {
    const inscripcionId = req.params.id; 
    ...
    try {
        ...
        const affectedRows = await patrocinadorTorneoModel.deletePatrocinadorATorneo(inscripcionId);
